...

{
	...
	xdg.configFile."hypr/wallpapers" = {
		source = "${inputs.self}/hosts/nixos/hypr/wallpapers";
		recursive = true;
	};
	...
	wallpaper {
		monitor =
		path = ${config.home.homeDirectory}/.config/hypr/wallpapers/default.jpg
		fit_mode = cover
	}
	'';
	...
	home.packages = with pkgs; [
		...
		# hyprland
		hyprpaper # added here to avoid issues with home manager
		pavucontrol
		dunst
		grimblast
		playerctl
